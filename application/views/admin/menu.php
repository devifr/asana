...
stm_aix("p3i0","p1i0",[0,"Page Manager","","",-1,-1,0,"#","_self","","","","",6,0,0,"<?php echo base_url('asset/images/menu/arrow_r.gif');?>","<?php echo base_url('asset/images/menu/arrow_w.gif');?>",7,7]);
stm_bpx("p4","p1",[1,2,-3,0,2,3,0]);
stm_aix("p4i0","p1i0",[0,"View List Page","","",-1,-1,0,"<?php echo base_url('admin/article/'); ?>"]);
stm_ep();
stm_aix("p3i2","p1i4",[]);
stm_aix("p3i0","p1i0",[0,"Partner","","",-1,-1,0,"#","_self","","","","",6,0,0,"<?php echo base_url('asset/images/menu/arrow_r.gif');?>","<?php echo base_url('asset/images/menu/arrow_w.gif');?>",7,7]);
stm_bpx("p4","p1",[1,2,-3,0,2,3,0]);
stm_aix("p4i0","p1i0",[0,"Add","","",-1,-1,0,"<?php echo base_url('admin/partner/input/');?>","_self","","","","",0]);
stm_aix("p4i1","p4i0",[0,"View List Partner","","",-1,-1,0,"<?php echo base_url('admin/partner/'); ?>"]);
stm_aix("p3i2","p1i4",[]);
stm_ep();
stm_aix("p3i0","p1i0",[0,"Client","","",-1,-1,0,"#","_self","","","","",6,0,0,"<?php echo base_url('asset/images/menu/arrow_r.gif');?>","<?php echo base_url('asset/images/menu/arrow_w.gif');?>",7,7]);
stm_bpx("p4","p1",[1,2,-3,0,2,3,0]);
stm_aix("p4i0","p1i0",[0,"Add","","",-1,-1,0,"<?php echo base_url('admin/client/input/');?>","_self","","","","",0]);
stm_aix("p4i1","p4i0",[0,"View List Client","","",-1,-1,0,"<?php echo base_url('admin/client/'); ?>"]);
stm_ep();
stm_aix("p3i2","p1i4",[]);
stm_aix("p3i1","p3i0",[0,"Careers","","",-1,-1,0,"#"]);
stm_bpx("p6","p4",[]);
...
stm_ep();
stm_aix("p3i5","p1i4",[]);
stm_aix("p3i1","p3i0",[0,"Section","","",-1,-1,0,"#","_self","","","","",6,0,0,"<?php echo base_url('asset/images/menu/arrow_r.gif');?>",""]);
stm_bpx("p5","p4",[]);
stm_aix("p5i1","p4i0",[0,"View List Section","","",-1,-1,0,"<?php echo base_url('admin/section/'); ?>"]);
stm_ep();
// stm_aix("p3i5","p1i4",[]);
